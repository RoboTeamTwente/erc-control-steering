 ...
 * C/C++ source code generated on : Wed Jul  8 16:56:47 2026
 *
 ...
 * '<S2>'   : 'codegen_drive/control_drive/getting the steering angles and turing radii'
 * '<S3>'   : 'codegen_drive/control_drive/getting the wheel speeds from the turning radii'
 * '<S4>'   : 'codegen_drive/control_drive/setting the desired speed of the shassis'
 */
